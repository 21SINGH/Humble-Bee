...
export default function HiveHistory() {
  ...
  const fetchLogs = async () => {
    const result = await db.getAllAsync<HiveLog>(`SELECT * FROM HiveLog ORDER BY date_placed DESC`);
    setLogs(result);
  };
  ...
  const deleteLog = (id: number) => {
    Alert.alert("Confirm Delete", "Are you sure you want to delete this hive log?", [
